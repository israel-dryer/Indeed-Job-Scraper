# In lines 147 through 151 of your file called "Indeed-Job-Scraper/indeed_job_scraper.py" I noticed that you had the #job search settings set up as follows:
...
# I took the time to try this code out, and then thought why not turn lines 149, and 150 into input statements instead.  Here is my contribution to this program.
...
if __name__ == '__main__':
    ...
    email_settings = EmailCredentials(
        username='touchdestroyer1980@gmail.com',
        password='Pi=2.718281828459045!',
        sender='touchdestroyer1980@gmail.com',
        recipient='touchdestroyer1980@gmail.com'
    )
